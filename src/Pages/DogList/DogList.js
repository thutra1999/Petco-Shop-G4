            ...
            <div className="row">
              <div className="col-lg-4">
                ...
                <h3 className="title_item">
                  Hướng dẫn cách làm pate cho chó thơm ngon, chó biếng ăn cũng
                  phải thèm
                </h3>
                <p>
                  Lưu ý: Rửa sạch gan heo, sau đó cắt thành từng miếng nhỏ vào
                  xay chung với thịt heo
                </p>
              ...
              <div className="col-lg-4">
                ...
                />
                <h3 className="title_item">
                  Lợi ích của việc cho trẻ nuôi thú cưng
                </h3>
                <p>
                  Lưu ý: Gia đình có trẻ nhỏ mắc các bệnh về dị ứng và hen suyễn
                  thì không nên cho bé tiếp xúc gần với thú cưng
                </p>
                <p className="text-center">
                  <a
                    href="https://www.petcity.vn/loi-ich-cua-viec-cho-tre-nuoi-thu-cung.html-1"
                    alt="Lợi ích của việc cho trẻ nuôi thú cưng"
                  >
                    <button type="button" class="btn btn-danger">
                      Xem chi tiết
                    </button>
              ...
              <div className="col-lg-4">
                ...
                />
                <h3 className="title_item">
                  Sự thật bất ngờ về giấc ngủ của chó
                </h3>
                <p>
                  Lưu ý: Nếu phát hiện chó của bạn bị thiếu ngủ hay mất ngủ đột
                  ngột, hãy mang cún yêu đến bác sĩ thú y để kiểm tra ngay nhé !
                </p>
                <p className="text-center">
                  <a
        ...
        <div className="row feturette">
          <div className="col-md-7 order-md-2 ">
            <h1 className="text-center">
              ...
              Cách quy đổi tuổi chó mèo sang tuổi người
            </h1>
            <p className="text-center">
